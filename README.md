To run this, clone the repository, run pip install -r requirements.txt, and run notebooks/orbits.ipynb. 
There might be an error where the kernel folder is not located, in that case just create a folder named kernels in data/.
